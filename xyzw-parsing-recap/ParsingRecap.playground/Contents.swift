...
//VoiceMemosTests.swift:257, testStopMemo failed in 0.011 seconds.
//┃
//┃ State change does not match expectation: …
//┃
//┃       VoiceMemosState(
//┃         alertMessage: nil,
//┃         audioRecorderPermission: RecorderPermission.undetermined,
//┃         currentRecording: nil,
//┃         voiceMemos: [
//┃           VoiceMemo(
//┃             date: 2020-07-07T15:21:21Z,
//┃             duration: 30.0,
//┃     −       mode: Mode.playing(
//┃     −         progress: 2.0
//┃     −       ),
...
//┃             title: "",
//┃             url: https://www.pointfree.co/functions
//┃           ),
//┃         ]
//┃       )
//┃
...
let logs = """
2020-08-19 10:30:36.590 xcodebuild[44019:3826548]  IDETestOperationsObserverDebug: Writing diagnostic log for test session to:

Test Case '-[VoiceMemosTests.VoiceMemosTests testPlayMemoFailure]' started.
/Users/point-free/projects/swift-composable-architecture/Examples/VoiceMemos/VoiceMemosTests/VoiceMemosTests.swift:225: error: -[VoiceMemosTests.VoiceMemosTests testPlayMemoFailure] : State change does not match expectation: …

      VoiceMemosState(
    −   alert: nil,
    +   alert: AlertState<VoiceMemosAction>(
    +     title: "Voice memo playback failed.",
    +     message: nil,
    +     primaryButton: nil,
    +     secondaryButton: nil
    +   ),
...
(Expected: −, Actual: +)
Test Case '-[VoiceMemosTests.VoiceMemosTests testPlayMemoFailure]' failed (0.004 seconds).

Test Case '-[VoiceMemosTests.VoiceMemosTests testDeleteMemo]' started.
Test Case '-[VoiceMemosTests.VoiceMemosTests testDeleteMemo]' passed (0.002 seconds).
