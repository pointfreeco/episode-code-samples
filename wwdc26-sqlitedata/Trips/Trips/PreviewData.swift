    ...
    try write { db in
      try db.seed {
        Trip.Draft(
          ...
          geofence: [
            Location(latitude: 35.6864, longitude: 139.6400),
            Location(latitude: 35.6864, longitude: 139.6600),
            Location(latitude: 35.6664, longitude: 139.6600),
            Location(latitude: 35.6664, longitude: 139.6400),
          ],
        ...
        Trip.Draft(
          ...
          geofence: [
            ...
            Location(latitude: 48.8666, longitude: 2.3622),
            Location(latitude: 48.8466, longitude: 2.3622),
            Location(latitude: 48.8466, longitude: 2.3422),
          ],
        ...
        Trip.Draft(
          ...
          geofence: [
            ...
            Location(latitude: 40.7228, longitude: -73.9960),
            Location(latitude: 40.7028, longitude: -73.9960),
            Location(latitude: 40.7028, longitude: -74.0160),
          ],
        ...
        Trip.Draft(
          ...
          geofence: [
            Location(latitude: 40.692732, longitude: -73.985876),
            Location(latitude: 40.692732, longitude: -73.965876),
            Location(latitude: 40.672732, longitude: -73.965876),
            Location(latitude: 40.672732, longitude: -73.985876),
          ],
          startDate: previewDate(2026, 2, 9),
          endDate: previewDate(2026, 2, 11),
          purpose: .business(.init(perdiem: 80)),
        ...
        Trip.Draft(
          ...
          geofence: [
            Location(latitude: 39.9626, longitude: -75.1752),
            Location(latitude: 39.9626, longitude: -75.1552),
            Location(latitude: 39.9426, longitude: -75.1552),
            Location(latitude: 39.9426, longitude: -75.1752),
          ],
