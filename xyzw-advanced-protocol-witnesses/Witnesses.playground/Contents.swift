...
//
//extension Equating {
//  static func tuple<B>(_ a: Equating, _ b: Equating<B>) -> Equating<(A, B)> {
...
//  let call: (A) -> A
//  func combine(with f: Endo) -> Endo {
//    return Endo { a in f.call(self.call(a)) }
//  }
//}
//
//extension Combining {
...
Directions.init(rawValue: "D")
Directions.init(rawValue: "X")
