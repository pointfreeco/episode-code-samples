...
@Model class Trip {
    ...
    init(name: String, destination: String, startDate: Date = .now, endDate: Date = .distantFuture, location: Location? = nil) {
        self.name = name
...
class PersonalTrip: Trip {
    ...
    init(name: String, destination: String, startDate: Date = .now, endDate: Date = .distantFuture, reason: Reason, location: Location? = nil) {
        self.reason = reason
        super.init(name: name, destination: destination, startDate: startDate, endDate: endDate, location: location)
    }
...
class BusinessTrip: Trip {
    ...
    init(name: String, destination: String, startDate: Date = .now, endDate: Date = .distantFuture, perdiem: Double?, location: Location? = nil) {
...
extension Trip {
    ...
    static var previewTrips: [Trip] {
        [
            BusinessTrip(name: "WWDC2026", destination: "Cupertino",
