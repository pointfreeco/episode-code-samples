...
struct AddTripView: View {
            ...
            Section(header: Text("Trip Destination")) {
                TripGroupBox {
                    ...
                    Button {
                        ...
                        HStack {
                            Text(destination.isEmpty ? "Search for a destination…" : destination)
    ...
    private func addTrip() {
        withAnimation {
            ...
            let newTrip: Trip
            if newTripSegment == .personal {
                newTrip = PersonalTrip(name: name,
                ...
                newTrip = BusinessTrip(name: name,
                                       destination: destination,
                                       startDate: startDate,
                                       endDate: endDate,
                                       perdiem: perdiem,
                ...
                newTrip = Trip(name: name, destination: destination, startDate: startDate, endDate: endDate, location: location)
            }
