...
let articlesReducer = Reducer<ArticlesState, ArticlesAction, Void> { state, action, _ in
  switch action {
...
//    state.articles = placeholderArticles
...
//          Store(initialState: <#T##_#>, reducer: <#T##Reducer<_, _, Environment>#>, environment: <#T##Environment#>)
